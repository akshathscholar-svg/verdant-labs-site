/* ── Shared SVG icon library — no emojis, clean & professional ── */
...
export function SeedlingIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7 20h10" />
      <path d="M12 20v-8" />
      <path d="M12 12c-3.5 0-6-2.5-6-6 4 0 6 2.5 6 6Z" />
      <path d="M12 12c3.5 0 6-2.5 6-6-4 0-6 2.5-6 6Z" />
    </svg>
  );
}
...
export function TreeIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 22H7l3-9H7l3-7h4l3 7h-3l3 9Z" />
    </svg>
  );
}
...
export function FlowerIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M19.07 4.93a3 3 0 0 0-4.24 4.24" />
      <path d="M22 12a3 3 0 0 0-6 0" />
      <path d="M19.07 19.07a3 3 0 0 0-4.24-4.24" />
      <path d="M12 22a3 3 0 0 0 0-6" />
      <path d="M4.93 19.07a3 3 0 0 0 4.24-4.24" />
      <path d="M2 12a3 3 0 0 0 6 0" />
      <path d="M4.93 4.93a3 3 0 0 0 4.24 4.24" />
    </svg>
  );
}

export function PalmIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M13 8c0-2.76-2.46-5-5.5-5-1.93 0-3.5 1-3.5 3 0 2.5 3 3.5 6 3.5" />
      <path d="M13 7.14A5.82 5.82 0 0 1 16.5 6c3.04 0 5.5 2.24 5.5 5 0 2-1.57 3-3.5 3-3 0-6-1-6-3.5" />
      <path d="M13 22V10" />
      <path d="M10 22h6" />
    </svg>
  );
...
export function CloverIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a4 4 0 0 0-4 4c0 1.5.8 2.8 2 3.5L12 12" />
      <path d="M12 2a4 4 0 0 1 4 4c0 1.5-.8 2.8-2 3.5L12 12" />
      <path d="M2 12a4 4 0 0 0 4 4c1.5 0 2.8-.8 3.5-2L12 12" />
      <path d="M2 12a4 4 0 0 1 4-4c1.5 0 2.8.8 3.5 2L12 12" />
      <path d="M22 12a4 4 0 0 0-4-4c-1.5 0-2.8.8-3.5 2L12 12" />
      <path d="M22 12a4 4 0 0 1-4 4c-1.5 0-2.8-.8-3.5-2L12 12" />
      <path d="M12 22V12" />
    </svg>
  );
}

export function CactusIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M10 21V7c0-2.2-1.8-4-4-4" />
      <path d="M6 7v4c0 1.1.9 2 2 2h2" />
      <path d="M14 21V11c0-2.2 1.8-4 4-4" />
      <path d="M18 11v2c0 1.1-.9 2-2 2h-2" />
      <path d="M7 21h10" />
    </svg>
  );
}
...
export function DropletIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5S12 6 12 2c0 4-2.5 6-4.5 8S5 13 5 15a7 7 0 0 0 7 7Z" />
    </svg>
  );
}
...
export function PlantPotIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 14h14l-1.5 7H6.5L5 14Z" />
      <path d="M4 12h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2Z" />
      <path d="M12 12V6c0-1.7 1.3-3 3-3h1" />
      <path d="M12 8c-2 0-4-1-4-3" />
    </svg>
  );
}
...
export function FogIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function RulerIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function RecycleIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="m9.344 5.811 1.093-1.892A1.83 1.83 0 0 1 12 3a1.83 1.83 0 0 1 1.563.919l3.974 6.867" />
      <path d="m20.898 13.403-4.096-1.098L15.709 16.4" />
    </svg>
  );
}
...
export function SnakeIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 20C4 16 8 12 12 12s8-4 8-8" />
      <path d="M18 4h2v2" />
    </svg>
  );
}
...
export function BirdIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M16 7h.01" />
      <path d="M3.4 18H12a8 8 0 0 0 8-8V7a4 4 0 0 0-7.28-2.3L2 20" />
      <path d="m20 7 2 .5-2 .5" />
      <path d="M10 18v3M14 17.75V21M4 21h16" />
    </svg>
  );
}

export function BeadsIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function PeaceIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" />
      <path d="M12 2v20M2 12l5.5 5.5M22 12l-5.5 5.5" />
    </svg>
  );
}
...
export function WheatIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 22 16 8" />
